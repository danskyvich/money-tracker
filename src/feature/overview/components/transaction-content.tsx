...
import { DeleteTransaction, InsertTransaction, UpdateTransaction } from "@/supabase/dbActions";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col w-full mt-5">
        ...
        <button
          type="submit"
          className="flex w-full h-full py-1 text-[0.9rem] items-center justify-center border border-(--color-brand-green) bg-(--color-brand-green) hover:bg-emerald-700 active:bg-emerald-800 rounded-lg cursor-pointer mt-2 duration-100 transition-all"
        >
        ...
        {selectedTransaction ? (
          <button
            ...
            className="flex w-full rounded-lg bg-transparent border border-(--color-brand-green) hover:bg-(--color-brand-green) active:bg-emerald-700 hover: text-[0.9rem] hover:text-white items-center justify-center py-1 mt-3 cursor-pointer transition-all duration-100"
          >
