...
export default function Profile() {
    ...
    return (
      <Card
        header="Profile"
        subheader="View and edit profile information"
        className="flex w-full h-full"
      >
        <div className="flex flex-col w-full h-full p-5">
          {/* User header */}
          <div className="flex flex-0 w-full h-fit gap-5 p-5 rounded-xl bg-linear-to-r from-slate-800 to-emerald-600">
            {/* Avatar */}
          ...
          <div className="flex flex-col p-5 w-full h-fit gap-3">
            ...
            <SettingItem
              ...
              tooltip="Your password cannot be changed if you signed up using Google"
            >
              <Button
