...
const TRANSACTIONS = [
  {amount: 50, account: "Wallet", time: ""},
]

const TransactionItem = ({amount, account, time, type}: {amount: number, account: string, time: string, type: string }) => {
      ...
      <div className="flex flex-col w-full h-full px-10 gap-5 pb-5">
        ...
        <div className="flex w-full h-full gap-5">
          ...
          <div className="flex w-full h-full flex-col gap-5">
            <Card header="Monthly summary" subheader="Outflows and Inflows"></Card>

            <Card header="Your accounts"></Card>
          </div>
        </div>
      </div>
    );
