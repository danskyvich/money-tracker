...
export default function TransactionModalSkeleton() {
    return (
      <div className="flex flex-col w-100 h-110 mx-5 sm:mx-0 sm:w-110 gap-5 p-5 bg-(--color-bg-secondary) md:w-125 lg:w-140 xl:w-160 border border-(--color-border-default)">
